...
class HomePresenter(private val homeView: HomeView, private val context: Context) {
    ...
    it.token ="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJodHRwczovL3RoZS1jaGFuY2Uub3JnLyIsInN1YiI6IjYyNzdkNzMzLTRkN2ItNDZkZS1hMDNmLWI5MGViODEzYWQwYSIsInRlYW1JZCI6IjdjMzBhMDQwLTFiYWQtNDk2Ni1hN2YxLTZhZjk4ZGMzZmFiMyIsImlzcyI6Imh0dHBzOi8vdGhlLWNoYW5jZS5vcmcvIiwiZXhwIjoxNjgxNjE3NTQ1fQ.Wep9eEuMl0t2_oXbwbh5nGQ5_VI8eWqUkz-1z1Ol3UU"} }
    ...
    fun getPersonalTask(status: Set<Int>) {
        personalTaskService.getAllTasks(
            ...
            onSuccess = { response ->
                ...
                val personalTasks = personalTasksResponse.tasksListPerson?.filter { it.statusPersonalTask in status }
