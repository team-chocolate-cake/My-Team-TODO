...
class AddNewTaskPresenter(private val context: Context,private val addNewTaskView: AddNewTaskView) {
    private var sharedPreferences = com.chocolatecake.todoapp.core.data.local.TaskSharedPreferences()
    ...
    fun createPersonalTask(title: String, description: String){
        val personalTaskRequest =
            com.chocolatecake.todoapp.core.data.model.request.PersonalTaskRequest(
                title,
                description
            )
    ...
    fun createTeamTask(title: String, description: String, assignee: String) {
        val teamTaskRequest = com.chocolatecake.todoapp.core.data.model.request.TeamTaskRequest(
            title,
            description,
            assignee
        )
